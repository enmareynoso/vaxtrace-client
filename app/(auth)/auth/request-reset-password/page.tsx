...
const RequestResetPassword: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const messageFromSession = sessionStorage.getItem("resetPasswordMessage");
    if (emailFromSession) setEmail(emailFromSession);
    if (messageFromSession) setMessage(messageFromSession);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage(error.message || "An error occurred while requesting the password reset.");
    }
  };
