...
export function CardSummary(props: CardSummaryProps) {
  const {average,title,icon: Icon,tooltipText,total} = props
    return (
    <div className='shadow-sm bg-background rounded-lg p-5 py-3 hover:shadow-lg transition hover:cursor-pointer'>
